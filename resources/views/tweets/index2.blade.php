    ...
    <div class="overflow-x-hidden bg-gray-100">
        <nav class="px-6 py-4 bg-white shadow">
            <div class="container flex flex-col mx-auto md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex-col hidden md:flex md:flex-row md:-mx-4">
                    <a href="{{route('tweets.create')}}" class=" my-1 text-gray-800 hover:text-blue-500 md:mx-4 md:my-0">ツイートする</a>
        ...
        <div class="mt-6">
            <div class="max-w-xl px-10 pt-6 pb-2 mx-auto bg-white rounded-lg shadow-md">
                <div class="flex mt-4">
                    <div><img src="{{ asset('storage/profile_image/' .$timeline->user->profile_image) }}" alt="avatar" class=" hidden object-cover w-20 h-20 mx-4 rounded-full sm:block items-center "></div>
                    <div class="font-bold items-center flex text-2xl text-gray-700 hover:underline">
                        <h1><a href="{{ url('users/' .$timeline->user->id) }}">{{ $timeline->user->screen_name }}</a></h1>
                    </div>
                    <div class="text-sm flex items-center "><span>@</span>{{ $timeline->user->name }}</div>
                    <div class=" text-gray-600 font-light flex items-center ml-4">
                    ...
                    <div class="flex items-center ml-auto ">
                        ...
                        <div x-data="{ dropdownOpen: false }" class="flex items-center ">
